...
RUNTIME_API RuntimeStatus runtime_load_models(int num_models,
                                              const ModelConfig *model_configs);

RUNTIME_API RuntimeStatus runtime_enqueue_input(int model_id,
                                                Tensors *input_tensors);

RUNTIME_API RuntimeStatus runtime_retrieve_output(int *model_id,
